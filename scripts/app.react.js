...
var TodoItem = React.createClass({displayName: 'TodoItem',
    ...
    render: function(){
        return (
            React.DOM.li(null, 
                React.DOM.label( {className:"toggle icon-delete", onClick:this.remove}),
                this.props.todo
            )
        );
    }
...
var AddTodoItem = React.createClass({displayName: 'AddTodoItem',
    ...
    render: function(){
        ...
        return (
            React.DOM.ul( {className:"todo-controls"}, 
                React.DOM.li( {className:showInput}, 
                    React.DOM.input( {type:"text", ref:"todo", onKeyUp:this.addEvent, placeholder:"Enter todo", autoFocus:true}),
                    React.DOM.a( {className:"icon-add", onClick:this.add}, "Add")
                ),
                React.DOM.li( {className:showAdd}, 
                    React.DOM.a( {className:"icon-add", onClick:this.edit}, "Add")
                )
            )
        );
    }
...
var TodoApp = React.createClass({displayName: 'TodoApp',
    ...
    render: function(){
        ...
        return (
            React.DOM.div(null, 
                React.DOM.section( {className:"todo"}, 
...
},{"./TodoModel.js":121,"react":119}],121:[function(require,module,exports){
...
},{"./Utils.js":122}],122:[function(require,module,exports){
var Utils = {};
